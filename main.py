...
if __name__ == '__main__':
    ...
    #python counter.py -f1 prediction.clf -f2 test.clf -g clf_signature.yaml
            ...
            for sen, tar_s, tar_f, tar_i in zip(sent,sense_pred,frg_pred,inter_pred):
                ...
                decode(sen, [tuple_to_dictlist(t_s) for t_s in tar_s], [tuple_to_list(t_f) for t_f in tar_f], [tuple_to_iterlabels(t_i) for t_i in tar_i], senses.token_to_ix, i+1, pred_file)
    pred_file.close()
